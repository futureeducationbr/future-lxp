module Schools
  module Targets
    class CreateContentBlockForm < Reform::Form
      ...
      validates :file, presence: true, image: true, file_size: { less_than: 30.megabytes }, if: :image_block?
      validates :file, presence: true, file_size: { less_than: 20.megabytes }, if: :file_block?
